...
require __DIR__ . '/../../modelos/Hotel.php';
    ...
    if(isset($errores)){
        ...
        if (!(($_FILES['userfile']['type'] == "application/msword" ||  strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "png")) && ($tamano_archivo < 500000))) {
            ...
            $hotel = new Hotel;
            $hotel->actualizar($_POST["id_hotel"],$_POST["nombre"],$_POST["direccion"],$_POST["categoria"],$nombre_archivo,$_POST["id_ciudad"], $_POST["descripcion"]);
    
                $_SESSION['message'] = [
                           'type' => 'success',
                           'text' => 'Se ha editado el Hotel con exito!'
                       ];
        }else{
